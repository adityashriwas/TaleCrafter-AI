...
const DashboardHeader = () => {
  ...
  return (
    <div className="px-2 py-1.5 sm:px-7 border border-neutral-800 bg-neutral-900/50 p-8 shadow flex justify-between items-center">
      <h2 className="text-2xl sm:text-3xl tracking-tight block w-full bg-gradient-to-b from-white to-gray-400 bg-clip-text font-bold text-transparent">My Stories</h2>
